...
const nameField = z.string().regex(alphaRegex, 'A name can only contain letters and special characters');
...
// baseUserSchema : To use in front-end when athering user inputs, for pw validation
