...
const config = {
  ...
  "inlineSchemaHash": "ce5c922ed6dcde8521f60eeafd90b1cf8bdcc092aaba78d5b9ce1f6102408d33",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/server/prisma/generated/prisma-users",
    "server/prisma/generated/prisma-users",
  ]
...
path.join(process.cwd(), "apps/server/prisma/generated/prisma-users/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/server/prisma/generated/prisma-users/schema.prisma")
